...
datadir = '/Users/nayman/Documents/REB/TS8/RTM8/singleclockscans/run-5593D'
...
plot_corrcoef_raft(l[0], ROIrows=slice(190, 1990), ROIcols=slice(522, 576), xylabels=l[1], title='run-5593D')
